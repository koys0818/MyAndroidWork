...
public class MainActivity extends AppCompatActivity {
    ...
    //엑티비티를 통해 다루고 있던 데이터저장 쓰레드중지둥을 처리해야됨
    @Override
    ...
    //직전에 저장되어있던 엑티비티의 상태정보가 있다면
    //onRestoreInstanceState 는  onstart 직후에 해줘야함
    @Override
    ...
    //엑티비티 소멸 전에 호출된다. ( 주의 onpause 뒤에 호출된다고 간주하지 말것
    //outstate : <-- 엑티비티 정보 저장(백업)하여 나중에 oncreate 에서 사용가능
    @Override
