...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //방법3
//        BackThread3 thread3 = new BackThread3(handler3);
...
//        thread3.start();
    ...
    public void mOnClick(View v){
        mainValue++;
        tvMainValue.setText("메인스레드 : " + mainValue);
    }
    ...
    class BackThread1 extends Thread{
        ...
        public void run() {
            while(true){
                //방법1 : 메인에서 생성된 핸들러 객체의 sendEmptyMessage 를 통해 Message 전달
                backValue1++;
                handler1.sendEmptyMessage(1);

                //방법2 : 메인에서 생성된 handler 객체의 postxxx() 를 통해 Rinnable 객체 전달
                backValue2 += 2;
    ...
    Handler handler1 = new Handler(){
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            if(msg.what == 1){
                tvBackValue1.setText("BackValue1" + backValue1);    //메인스헤드의 ui 변경
...
class BackThread3 extends Thread{
    ...
    public void run() {
        while (true){
            ...
            handler.sendMessage(msg);  //메인스헤드의 핸들러에 메세지보내기
