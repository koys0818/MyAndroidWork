...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new MysSQLiteOpenHelper4(
                this,
                dbName,
                null,
                dbVersion
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if("".equals(name)){
                    tvResult.setText("DELECT 실패 - 삭제할 이름을 입력하세요");
                    return;
                }
    ...
    void update(String name, int age , String address){
        ...
        String msg = String.format("%d개의 eow update 성공", cnt);
    ...
    void delete(String name){
        ...
        //리턴값은 affected raws 정수값

        int cnt = db.delete(tableName,
                "name=?",
                new String[]{name});

        String msg = String.format("%d개의 eow delect 성공", cnt);
        tvResult.setText(msg);
        Log.d("myapp","msg");
        select();
