...
public class Main3Activity extends AppCompatActivity {
    ...
    MysSQLiteOpenHelper3 helper;
    String dbname = "st_file.db";   //파일의 형태로 DB가 저장된다
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new MysSQLiteOpenHelper3(
                this,   //현재화면의 제어권자
                dbname, //DB 이름
...
//        db = helper.getReadableDatabase();  // 읽기전용 DB  ex) SELECT만 사용하는 경우
