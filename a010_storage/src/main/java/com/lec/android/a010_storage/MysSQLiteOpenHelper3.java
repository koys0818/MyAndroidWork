...
public class MysSQLiteOpenHelper3 extends SQLiteOpenHelper {
    public MysSQLiteOpenHelper3(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        String sql = "DROP TABLE mytable";  //기존케이블 삭제
        db.execSQL(sql);
